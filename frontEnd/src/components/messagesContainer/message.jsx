...
export default function Message({ message, receiverName, messageContent, sentTime }) {
    ...
    <>
      <div className="">
        <div className={`chat ${chatClassType}`}>
          ...
          <div className={`chat-bubble max-w-48 max-h-32 break-all text-white overflow-y-scroll overflow-x-clip ${bubbleBgColor}`}>{messageContent}</div>
